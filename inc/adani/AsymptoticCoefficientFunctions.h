...
double
C2_g2_asymptotic(double x, double m2Q2, double m2mu2);
double
C2_ps2_asymptotic(double x, double m2Q2, double m2mu2);

double
CL_g2_asymptotic(double x, double m2Q2, double m2mu2);
double
CL_ps2_asymptotic(double x, double m2Q2, double m2mu2);
...
double C2_g3_asymptotic(
    double x, double m2Q2, double m2mu2, int nf, int v1,
    int v2
);
double C2_ps3_asymptotic(
    double x, double m2Q2, double m2mu2, int nf, int v
);
double CL_g3_asymptotic(
    double x, double m2Q2, double m2mu2, int nf, int v
);
double CL_ps3_asymptotic(
    double x, double m2Q2, double m2mu2, int nf, int v
);
