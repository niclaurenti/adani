...
double C2_g1_approximation_implicit(
    double x, double m2Q2, double k, double h
);
...
double C2_g2_approximation(
    double x, double m2Q2, double m2mu2, int v = 0
);
double C2_g20_approximation(double x, double m2Q2);
double C2_g20_approximation_implicit(
    double x, double m2Q2, double A, double B, double C,
...
double C2_g30_approximation_implicit(
    double x, double m2Q2, int nf, double A, double B,
    double C, double D, double a, double b, int v1, int v2
);
double C2_g30_approximation_BAND(
    double x, double m2Q2, int nf, int v, double var,
    double fact
);
double C2_ps3_approximation(
    double x, double m2Q2, double m2mu2, int nf, int v = 0
);
double C2_ps30_approximation(double x, double m2Q2, int nf);
double C2_ps30_approximation_implicit(
    double x, double m2Q2, int nf, double A, double B,
    double C, double D, double a, double b, int v
);
...
double C2_g2_approximationA_klmv(
    double x, double m2Q2, double m2mu2
);
double C2_g2_approximationB_klmv(
    double x, double m2Q2, double m2mu2
);

double C2_ps2_approximationA_klmv(
    double x, double m2Q2, double m2mu2
);
double C2_ps2_approximationB_klmv(
    double x, double m2Q2, double m2mu2
);
...
double C2_ps3_approximationA_klmv(
    double x, double m2Q2, double m2mu2, int nf
);
double C2_ps3_approximationB_klmv(
    double x, double m2Q2, double m2mu2, int nf
);

double C2_ps3_approximationA_klmv_paper(
    double x, double m2Q2, double m2mu2, int nf
);
double C2_ps3_approximationB_klmv_paper(
    double x, double m2Q2, double m2mu2, int nf
);
