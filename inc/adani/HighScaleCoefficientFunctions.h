...
double
C2_ps2_highscale(double z, double m2Q2, double m2mu2);
...
double
D2_ps2_highscale(double x, double m2Q2, double m2mu2);

double DL_g2_highscale(double z, double m2Q2, double m2mu2);
double
DL_ps2_highscale(double z, double m2Q2, double m2mu2);
...
double C2_g3_highscale(
    double x, double m2Q2, double m2mu2, int nf, int v = 0
);
double C2_ps3_highscale(
    double x, double m2Q2, double m2mu2, int nf
);

double CL_g3_highscale(
    double x, double m2Q2, double m2mu2, int nf
);
double CL_ps3_highscale(
    double x, double m2Q2, double m2mu2, int nf
);

double DL_g3_highscale(
    double z, double m2Q2, double m2mu2, int nf
);
double DL_ps3_highscale(
    double z, double m2Q2, double m2mu2, int nf
);

double D2_g3_highscale(
    double x, double m2Q2, double m2mu2, int nf, int v
);
double D2_ps3_highscale(
    double x, double m2Q2, double m2mu2, int nf, int v = 0
);
