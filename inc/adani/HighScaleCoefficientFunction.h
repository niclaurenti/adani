...
class HighScaleCoefficientFunction : public CoefficientFunction {
  ...
  private:
    ...
    // double
    // C2_ps3_highscale_klmv_paper(double x, double m2Q2, double m2mu2, int nf,
    // int v) const ; double D2_ps3_highscale_klmv_paper(double x, double m2Q2,
    // double m2mu2, int nf, int v) const ;
};
