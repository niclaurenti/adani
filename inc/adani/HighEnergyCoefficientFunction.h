...
class HighEnergyCoefficientFunction
  ...
  private:
    ...
    double ZeroFunction(double /*x*/, double /*m2Q2*/, double /*m2mu2*/) const {
        return 0.;
    };
...
class HighEnergyHighScaleCoefficientFunction
  ...
  private:
    ...
    double
    C2_ps3_highenergy_highscaleLL(double x, double m2Q2, double m2mu2) const;
    double
    CL_ps3_highenergy_highscaleLL(double x, double m2Q2, double m2mu2) const;
