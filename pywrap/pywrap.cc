...
PYBIND11_MODULE(adanipy, m) {
    ...
    m.def("C2m_g3_approximation", &C2m_g3_approximation, "prova", py::arg("x"), py::arg("mQ"), py::arg("mMu"), py::arg("nf"), py::arg("method_flag")=1, py::arg("calls")=500000);
    m.def("CLm_g3_approximation", &CLm_g3_approximation, "prova", py::arg("x"), py::arg("mQ"), py::arg("mMu"), py::arg("nf"), py::arg("method_flag")=1, py::arg("calls")=500000);
