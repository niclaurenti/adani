...
** check on the weight nw
     ...
     $          ' (the weight) = ',nw
        print*, ' the allowed values of the weight are 1,...,5 '
        stop
      endif
...
** (n1,n2) = (0,1) or (-1,1)
     ...
     $  - 3.0000000000000000d+00*HZ5(0,1,0,1,1)
      HZ5(0,1,1,1,0) =
     $  + HZ1(0)*HZ4(0,1,1,1) - HZ5(0,1,1,0,1) - HZ5(0,1,0,1,1)
     $  + (-HZ2(0,1)*HZ3(0,1,1) + HZ5(0,1,1,0,1) + 3*HZ5(0,1,0,1,1))/3.
      HZ5(1,0,0,0,1) =
     $  + HZ1(1) *HZ4(0,0,0,1)
     $  - HZ2(0,1) *HZ3(0,0,1)
     ...
     $  + 8.3333333333333333d-03*HZ1(1)*HZ1(1)*HZ1(1)*HZ1(1)*HZ1(1)
      HZ5(1,0,0,0,0) =
     $  + HZ1(0)*HZ1(0)*HZ1(0)*HZ1(0)*HZ1(1)/24.
     $  - HZ1(0)*HZ1(0)*HZ1(0)*HZ2(0,1)/6.
     $  + HZ1(0)*HZ1(0)*HZ3(0,0,1)/2.
     $  - HZ1(0)*HZ4(0,0,0,1)
     &  + HZ5(0,0,0,0,1)
      endif
