...
double C2_g20_approximation_BAND(double x, double m2Q2, int v, double var, double fact) {
    ...
    if(v==-1) return min ;
        ...
        cout << "C2_g20_approximation_BAND: Choose either v=0 or v=1 or v=2!!\nExiting!!\n" << endl;
        exit(-1);
    }
...
double CL_g20_approximation_BAND(double x, double m2Q2, int v, double var, double fact) {
    ...
    if(v==-1) return min ;
        ...
        cout << "CL_g20_approximation_BAND: Choose either v=0 or v=1 or v=2!!\nExiting!!\n" << endl;
        exit(-1);
    }
...
double C2_g30_approximation_BAND(double x, double m2Q2, int nf, int v, double var, double fact) {
    ...
    if(v==-1) return min ;
        ...
        cout << "C2_g30_approximation_BAND: Choose either v=0 or v=1 or v=-1!!\nExiting!!\n" << endl;
        exit(-1);
    }
