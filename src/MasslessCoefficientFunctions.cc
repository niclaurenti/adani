    ...
    return /*flav
           ...
           + nf * CF * CA
                 * (+6272. / 9 + 5296. / 45 * zeta2 / x - 1024. / 15 * zeta2 * x
                    ...
                    + 512. / 15 * zeta2 * zeta2 * x2
                    - 512. / 25 * zeta2 * zeta2 * x3 + 1856. / 15 * zeta3 / x
                    - 4384. / 45 * zeta3 * x + 2208. / 5 * zeta3 * x2
                    + 64. / 3 * zeta3 * x3 - 1824. / 5 * zeta3
                    - 71344. / 135 / x + 30944. / 27 * x - 59152. / 45 * x2
                    + 224. / 3 * H00m10 * x - 64 * H0m1 * zeta2 * x
                    + 256. / 3 * H0m1m10 * x - 96 * H0m10 + 64. / 3 * H0m10 / x
                    - 1664. / 9 * H0m10 * x + 704. / 3 * H0m10 * x2
                    + 128. / 15 * H0m10 * x3 + 608. / 3 * H0m100 * x
                    + 320. / 3 * H0m101 * x + 128. / 15 * Hm1 * zeta2 / x2
                    + 80 * Hm1 * zeta2 / x - 464. / 3 * Hm1 * zeta2 * x
                    - 160 * Hm1 * zeta2 * x2 - 64. / 5 * Hm1 * zeta2 * x3
                    + 64 * Hm1 * zeta2 - 256. / 3 * Hm1m10
                    + 256. / 45 * Hm1m10 / x2 + 32. / 3 * Hm1m10 / x
                    - 928. / 9 * Hm1m10 * x - 64. / 3 * Hm1m10 * x2
                    - 128. / 15 * Hm1m10 * x3 + 9728. / 45 * Hm10
                    - 64. / 45 * Hm10 / x2 + 4144. / 45 * Hm10 / x
                    - 10192. / 45 * Hm10 * x - 15616. / 45 * Hm10 * x2
                    + 32. / 15 * Hm10 * x3 - 608. / 3 * Hm100
                    - 256. / 45 * Hm100 / x2 - 320. / 3 * Hm100 / x
                    + 928. / 9 * Hm100 * x + 640. / 3 * Hm100 * x2
                    + 128. / 15 * Hm100 * x3 - 320. / 3 * Hm101
                    - 256. / 45 * Hm101 / x2 - 224. / 3 * Hm101 / x
                    + 928. / 9 * Hm101 * x + 448. / 3 * Hm101 * x2
                    + 128. / 15 * Hm101 * x3 - 6832. / 45 * H0
                    + 64. / 15 * H0 * zeta2 / x - 7376. / 45 * H0 * zeta2 * x
                    + 512. / 5 * H0 * zeta2 * x2 + 256. / 15 * H0 * zeta2 * x3
                    + 624. / 5 * H0 * zeta2 - 1568. / 3 * H0 * zeta3 * x
                    + 128. / 3 * H0 * zeta3 * x2 - 128. / 5 * H0 * zeta3 * x3
                    - 11456. / 135 * H0 / x + 101824. / 135 * H0 * x
                    + 161648. / 135 * H0 * x2 + 15376. / 45 * H00
                    - 976. / 3 * H00 * zeta2 * x - 128. / 3 * H00 * zeta2 * x2
                    + 128. / 5 * H00 * zeta2 * x3 + 256. / 45 * H00 / x
                    + 8192. / 15 * H00 * x - 61472. / 45 * H00 * x2
                    - 32. / 15 * H00 * x3 - 160 * H000 + 3536. / 9 * H000 * x
                    - 128. / 15 * H000 * x3 + 1216. / 3 * H0000 * x
                    - 2528. / 9 * H1 + 128. / 45 * H1 * zeta2 / x2
                    + 48 * H1 * zeta2 / x + 464. / 9 * H1 * zeta2 * x
                    + 96 * H1 * zeta2 * x2 + 64. / 15 * H1 * zeta2 * x3
                    - 608. / 3 * H1 * zeta2 - 256. / 15 * H1 * zeta3 / x2
                    + 64. / 3 * H1 * zeta3 / x - 64. / 3 * H1 * zeta3 * x
                    + 128. / 3 * H1 * zeta3 * x2 - 128. / 5 * H1 * zeta3 * x3
                    + 8176. / 135 * H1 / x - 3424. / 9 * H1 * x
                    + 81104. / 135 * H1 * x2 + 256. / 3 * H10
                    + 256. / 15 * H10 * zeta2 / x2 - 64. / 3 * H10 * zeta2 / x
                    + 64. / 3 * H10 * zeta2 * x - 128. / 3 * H10 * zeta2 * x2
                    + 128. / 5 * H10 * zeta2 * x3 - 1264. / 9 * H10 / x
                    + 752. / 3 * H10 * x - 1760. / 9 * H10 * x2
                    + 1424. / 5 * H100 - 1216. / 15 * H100 / x
                    - 752. / 15 * H100 * x - 768. / 5 * H100 * x2
                    + 224. / 3 * H11 - 1168. / 9 * H11 / x + 704. / 3 * H11 * x
                    - 1616. / 9 * H11 * x2 + 160 * H110 - 160. / 3 * H110 / x
                    - 320. / 3 * H110 * x2 + 256. / 15 * H1100 / x2
                    - 64. / 3 * H1100 / x + 64. / 3 * H1100 * x
                    - 128. / 3 * H1100 * x2 + 128. / 5 * H1100 * x3 + 160 * H111
                    - 160. / 3 * H111 / x - 320. / 3 * H111 * x2 + 160 * H101
                    - 160. / 3 * H101 / x - 320. / 3 * H101 * x2
                    - 256. / 15 * H1001 / x2 + 64. / 3 * H1001 / x
                    - 64. / 3 * H1001 * x + 128. / 3 * H1001 * x2
                    - 128. / 5 * H1001 * x3 + 992. / 9 * H01
                    ...
                    + 16. / 3 * H011 * x - 448. / 3 * H011 * x2
                    + 160 * H0110 * x + 160 * H0111 * x + 160 * H0101 * x
                    - 624. / 5 * H001 + 256. / 15 * H001 / x
                    - 944. / 45 * H001 * x - 512. / 5 * H001 * x2
                    - 128. / 15 * H001 * x3 + 320 * H0010 * x + 352 * H0011 * x
                    + 400 * H0001 * x + 128. / 3 * H0001 * x2
                    - 128. / 5 * H0001 * x3)
           + nf * CF * CF
                 * (+25648. / 225 - 352. / 9 * zeta2 / x
                    - 80176. / 135 * zeta2 * x + 1984. / 15 * zeta2 * x2
                    + 1088. / 225 * zeta2 * x3 - 11488. / 45 * zeta2
                    + 1424. / 15 * zeta2 * zeta2 * x
                    ...
                    - 108544. / 675 * x + 1136. / 675 * x2
                    - 64. / 3 * H00m10 * x - 96 * H0m1 * zeta2 * x
                    - 704. / 3 * H0m1m10 * x - 640. / 3 * H0m10
                    - 512. / 45 * H0m10 / x2 + 320. / 9 * H0m10 * x
                    + 128. / 3 * H0m10 * x2 - 64. / 15 * H0m10 * x3
                    + 64 * H0m100 * x - 64. / 3 * H0m101 * x
                    - 64. / 15 * Hm1 * zeta2 / x2 - 32. / 3 * Hm1 * zeta2 / x
                    + 352. / 3 * Hm1 * zeta2 * x + 64. / 3 * Hm1 * zeta2 * x2
                    + 32. / 5 * Hm1 * zeta2 * x3 + 96 * Hm1 * zeta2
                    + 704. / 3 * Hm1m10 - 128. / 45 * Hm1m10 / x2
                    + 64. / 3 * Hm1m10 / x + 1472. / 9 * Hm1m10 * x
                    - 128. / 3 * Hm1m10 * x2 + 64. / 15 * Hm1m10 * x3
                    - 2176. / 5 * Hm10 - 4736. / 675 * Hm10 / x2
                    - 352. / 45 * Hm10 / x - 56992. / 135 * Hm10 * x
                    + 256. / 15 * Hm10 * x2 + 1088. / 225 * Hm10 * x3
                    - 64 * Hm100 - 128. / 15 * Hm100 / x2 - 256. / 3 * Hm100 * x
                    + 64. / 5 * Hm100 * x3 + 64. / 3 * Hm101
                    ...
                    + 4544. / 27 * H00 * x - 64 * H00 * x2
                    - 1088. / 225 * H00 * x3 + 160 * H000 + 2000. / 9 * H000 * x
                    - 256 * H000 * x2 - 64. / 5 * H000 * x3 + 64 * H0000 * x
                    + 3344. / 5 * H1 - 64. / 45 * H1 * zeta2 / x2
                    + 32. / 3 * H1 * zeta2 / x - 736. / 9 * H1 * zeta2 * x
                    + 64. / 3 * H1 * zeta2 * x2 - 32. / 15 * H1 * zeta2 * x3
                    + 160. / 3 * H1 * zeta2 + 512. / 15 * H1 * zeta3 / x2
                    - 128. / 3 * H1 * zeta3 / x + 128. / 3 * H1 * zeta3 * x
                    - 256. / 3 * H1 * zeta3 * x2 + 256. / 5 * H1 * zeta3 * x3
                    - 19904. / 135 * H1 / x - 13856. / 45 * H1 * x
                    - 28816. / 135 * H1 * x2 + 544. / 3 * H10
                    - 512. / 15 * H10 * zeta2 / x2 + 128. / 3 * H10 * zeta2 / x
                    - 128. / 3 * H10 * zeta2 * x + 256. / 3 * H10 * zeta2 * x2
                    - 256. / 5 * H10 * zeta2 * x3 - 64. / 9 * H10 / x
                    - 544. / 3 * H10 * x + 64. / 9 * H10 * x2 - 768. / 5 * H100
                    + 512. / 15 * H100 / x + 1024. / 15 * H100 * x
                    + 256. / 5 * H100 * x2 + 752. / 3 * H11 - 208. / 9 * H11 / x
                    - 512. / 3 * H11 * x - 512. / 9 * H11 * x2 + 64 * H110
                    - 64. / 3 * H110 / x - 128. / 3 * H110 * x2
           ...
           + nf * nf * CF
                 * (-5248. / 45 - 64. / 9 * zeta2 / x + 160. / 3 * zeta2 * x
                    ...
                    + 128. / 9 * Hm10 * x2 + 64. / 15 * Hm10 * x3
                    - 256. / 5 * H0 + 128. / 45 * H0 / x - 8992. / 135 * H0 * x
                    ...
                    - 64. / 9 * H11 * x2 - 352. / 9 * H01 * x
                    - 64. / 9 * H01 * x2 + 32. / 3 * H011 * x);
}
