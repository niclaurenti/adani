...
double C2_g2_highenergy_highscale(double x, double mQ , double mMu) {
    ...
    return CA*overall*4*M_PI/xi/16/M_PI*(
        8./3.*L2Q + 104./9.*LQ + 40./9. - 16./3.*zeta2 + (16./3.*LQ + 8./3.)*Lm
   ) / x ;
...
double C2_g3_highenergy_ERR(double x, double mQ, double mMu, int nf) {
    ...
    double tmp = (
        ...
        + a11 * beta0 * (
            ...
            + (- 1472./144 * mQ - 1920./144 * mQ * ln2 + 1260./144 * mQ * zeta3)
       )
        + a11 * a11 * (
            Lmu2 * (1./2 * J * (-1 + mQ) - mQ)
        ...
        + Lmu * (
            ...
            + a11 * beta0 * (
                ...
                + (-480./144 * mQ - 1152./144 * mQ * ln2 + 756./144 * mQ * zeta3)
           )
       )
   );
