...
double D2m_ps3_highscale(double x, double mQ, double mMu, int nf) {
  ...
  delete Hr1;
    ...
    * (x - 1)/x * (904 * x2 + 2683 * x - 392) * H0 * H0 - 16.
    ...
    -80./27 * 1./x * (4 * x3 + 225 * x2 + 54 * x + 20) * H0
    * H0 - 16./27 * 1./x * (882 * x3 + 1527 * x2 - 2364 * x
    ...
    - 80./27 * 1./x * (104 * x3 - 39 * x2 - 105 * x - 56) +
    ...
    * x + 120) - 1792./3 * (x + 1) * H0) * H0011 + (-80./27
    ...
    * H0 * H0 + 1184./3 * (x + 1) * H01) * z3 + 1792 * (x + 
    ...
    + 4) * H1 * H1 * H1 * H1 - 80./27 * (x + 1)/x * (32 * x2
    ...
    * x2 + 657 * x - 140)) * H1 + (-32./9 * (x - 1)/x * (4 * 
    ...
    448./3 * (x - 1) * H0m1) * H0m1m1 + (80./27 * (x + 1)/x 
    ...
    * x2 - 413 * x + 200 ) * Hm1 - 8./3 * 1./x * (8 * x3 - 
    ...
    (80./27 * (x + 1)/x * (32 * x2 + 61 * x + 32) * Hm1 - 32.
    /9 * 1./x * (32 * x3 - 3 * x2 - 33 * x + 40) * H0 + 16.
    /27 * 1./x * (82 * x3 - 78 * x2 - 267 * x - 80)) * H01m1
    +( -176./9 * (x - 1)/x * (4 * x2 + 7 * x + 4) * H1 - 80.
    /27 * 1./x * (148 * x3 + 189 * x2 - 45 * x - 140) * H0
    ...
    * x - 7) * H0) * H0m101 - (64 * (x + 1) * (2 * x2 + x + 
    ...
    + 45 * x - 56) + 1168./3 * (x - 1) * H0) * H000m1 + (-80.
    /27 * 1./x * (68 * x3 - 1577 * x2 - 260 * x - 364) - 496
    * (3 * x + 1) * H0) * H0001 + (8./3 * (x + 1)/x * (88 * 
    x2 - 169 * x + 88) + 128./3 * (x + 1) * H0) * H001m1 + 
    (80./27 * 1./x * (40 * x3 + 617 * x2 + 119 * x - 164) +
    16./3 * (35 * x + 37) * H0) * H0011 - 64./9 * (x + 1)/x
    * (2 * x2 + x + 2) * (H01m11 + H011m1) + (80./27 * 1./x 
    ...
    * x - 211) * H0 * H0 - 80./27 * (5 * x - 4) * H0 * H0 * 
    ...
    1)/x * (88 * x2 + 235 * x + 88) * H1 - 80./27 * 1./x * 
