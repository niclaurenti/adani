...
double D2_ps3_highscale(double x, double mQ, double mMu, int nf, int v) {
    ...
    return (
        ...
        /243 * x2 + 128./27 * zeta3/x - 296./9 * zeta3 - 248./3 * zeta3
        * x - 1184./27 * zeta3 * x2 + 320./27 * zeta2/x + 1232./27
        * zeta2 + 992./27 * zeta2 * x - 224./27 * zeta2 * x2 + 8 * zeta2
        * zeta2 + 8 * zeta2 * zeta2 * x + 3704./81 * H0 - 3784./81 * H0
        * x + 6272./81 * H0 * x2 + 304./9 * H0 * zeta3 + 304./9
        * H0 * zeta3 * x + 8./3 * H0 * zeta2 + 40./3 * H0 * zeta2 * x
        + 64./9 * H0 * zeta2 * x2 - 1024./27 * H00 - 1600./27 *
        H00 * x - 400./9 * H00 * x2 - 16./3 * H00 * zeta2 - 16./3
        * H00 * zeta2 * x + 8./3 * H000 + 40./3 * H000 * x + 64./
        ...
        * H101 * x2 - 1160./27 * H01 - 632./27 * H01 * x - 176.
        ...
        1664./27 * x2 + 32./3 * zeta3 + 32./3 * zeta3 * x - 64./9 *
        zeta2/x - 64./3 * zeta2 * x + 64./3 * zeta2 * x2 - 64./3 * Hm10
        - 64./9 * Hm10/x - 64./3 * Hm10 * x - 64./9 * Hm10 *
        x2 + 560./9 * H0 - 176./3 * H0 * x - 1408./27 * H0 *
        x2 - 64./3 * H0 * zeta2 - 64./3 * H0 * zeta2 * x + 160./3 *
        ...
        * x + 416./9 * H1 - 416./27 * H1/x - 320./9 * H1 * x
        ...
        /9 * x2 + 32./3 * zeta2 + 32./3 * zeta2 * x - 16./3 * H0 -
        ...
        * x + 64./9 * H1 * x2 - 32./3 * H01 - 32./3 * H01 * x)
        ...
        4864./81 * x2 - 64./9 * zeta2/x - 64./3 * zeta2 * x - 64./3
        ...
        * H00 * x2 + 32 * H000 + 32 * H000 * x)
        ...
        x - 128./27 * x2 + 32./3 * zeta2 + 32./3 * zeta2 * x + 64./
        ...
        * x + 27152./729 * x2 + 256./27 * zeta3/x - 976./27 * zeta3
        - 928./27 * zeta3 * x + 32./27 * zeta3 * x2 + 1600./81 * zeta2
        + 1024./81 * zeta2 * x + 592./27 * zeta2 * x2 + 16 * zeta2 * zeta2
        + 16 * zeta2 * zeta2 * x + 6152./243 * H0 + 7736./243 * H0 *
        x - 800./81 * H0 * x2 - 32./9 * H0 * zeta3 - 32./9 * H0 *
        zeta3 * x + 160./27 * H0 * zeta2 - 128./27 * H0 * zeta2 * x -
        64./9 * H0 * zeta2 * x2 + 2192./81 * H00 + 464./81 * H00*
        x + 32./3 * H00 * x2 + 64./9 * H00 * zeta2 + 64./9 * H00
        * zeta2 * x + 392./27 * H000 + 104./27 * H000 * x - 64./
        9 * H000 * x2 + 80./9 * H0000 + 80./9 * H0000 * x - 688.
        /81 * H1 - 320./27 * H1/x - 752./81 * H1 * x + 800./27
        * H1 * x2 - 64./9 * H1 * zeta2/x - 16./3 * H1 * zeta2 + 16.
        /3 * H1 * zeta2 * x + 64./9 * H1 * zeta2 * x2 - 80./3 * H10
        ...
        * x - 592./27 * H01 * x2 - 32./3 * H01 * zeta2 - 32./3 *
        H01 * zeta2 * x - 208./9 * H010 - 112./9 * H010 * x + 64.
        ...
        * x2 - 32./3 * H0010 - 32./3 * H0010 * x + 32./9 * H0011
        ...
        + 64./3 * zeta3 + 64./3 * zeta3 * x - 64./9 * zeta2/x - 208./9
        * zeta2 - 304./9 * zeta2 * x + 64./9 * zeta2 * x2 - 64./3 * Hm10
        - 64./9 * Hm10/x - 64./3 * Hm10 * x - 64./9 * Hm10 * x2
        + 704./9 * H0 + 160./3 * H0 * x - 416./9 * H0 * x2 -
        32./3 * H0 * zeta2 - 32./3 * H0 * zeta2 * x + 256./9 * H00
        ...
        * H10 * x - 64./9 * H10 * x2 - 16./3 * H11 - 64./9 *
        ...
        + 128./9 * x2 + 16./3 * zeta2 + 16./3 * zeta2 * x - 8./3 *
        ...
        * x - 3104./81 * x2 + 16./3 * zeta3 + 16./3 * zeta3 * x - 64.
        /9 * zeta2/x - 128./9 * zeta2 - 368./9 * zeta2 * x - 32./9 * zeta2
        ...
        * H0 * x2 - 32./3 * H00 - 32./3 * H00 * x)
        ...
        /27 * x2 + 120 * zeta5 + 120 * zeta5 * x - 980./9 * zeta3 - 4276.
        /9 * zeta3 * x - 80 * zeta3 * x2 - 40 * zeta2/x + 290./3 * zeta2
        + 674./3 * zeta2 * x + 3064./27 * zeta2 * x2 - 184./3 * zeta2
        * zeta3 - 184./3 * zeta2 * zeta3 * x - 32 * zeta2 * zeta2 + 184./5 *
        zeta2 * zeta2 * x + 592./15 * zeta2 * zeta2 * x2 - 4594./27 * H0
        + 4030./27 * H0 * x + 1360./9 * H0 * x2 - 24 * H0 * zeta3
        + 256./3 * H0 * zeta3 * x - 32./9 * H0 * zeta3 * x2 - 139./
        3 * H0 * zeta2 - 467./3 * H0 * zeta2 * x + 368./9 * H0 * zeta2
        * x2 - 40 * H0 * zeta2 * zeta2 - 40 * H0 * zeta2 * zeta2 * x - 344.
        /3 * H00 - 422./3 * H00 * x + 176./27 * H00 * x2 - 16.
        /3 * H00 * zeta3 - 16./3 * H00 * zeta3 * x + 24 * H00 * zeta2
        + 8 * H00 * zeta2 * x - 32 * H00 * zeta2 * x2 - 92 * H000 -
        100 * H000 * x - 848./9 * H000 * x2 + 20 * H000 * zeta2
        + 20 * H000 * zeta2 * x + 8 * H0000 + 24 * H0000 * x + 32.
        /3 * H0000 * x2 - 5638./27 * H1 - 502./9 * H1/x + 1456.
        /27 * H1 * x + 632./3 * H1 * x2 + 32./9 * H1 * zeta3/x +
        8./3 * H1 * zeta3 - 8./3 * H1 * zeta3 * x - 32./9 * H1 * zeta3
        * x2 - 88./3 * H1 * zeta2/x - 106./3 * H1 * zeta2 + 178./3
        * H1 * zeta2 * x + 16./3 * H1 * zeta2 * x2 - 524./3 * H10 +
        1480./27 * H10/x - 20 * H10 * x + 3776./27 * H10 * x2
        - 32./3 * H10 * zeta2/x - 8 * H10 * zeta2 + 8 * H10 * zeta2 *
        x + 32./3 * H10 * zeta2 * x2 + 344./3 * H100 + 80./3 * H100
        /x - 248./3 * H100 * x - 176./3 * H100 * x2 + 24 * H1000
        + 32 * H1000/x - 24 * H1000 * x - 32 * H1000 * x2 - 128.
        /3 * H11 - 284./27 * H11/x - 100./3 * H11 * x + 2336.
        /27 * H11 * x2 + 16./3 * H11 * zeta2/x + 4 * H11 * zeta2 -
        4 * H11 * zeta2 * x - 16./3 * H11 * zeta2 * x2 + 164./3 * H110
        ...
        * H101 + 32 * H101/x - 60 * H101 * x - 32 * H101 * x2
        ...
        /3 * H01 * zeta3 + 16./3 * H01 * zeta3 * x - 52 * H01 * zeta2
        - 60 * H01 * zeta2 * x - 16./3 * H01 * zeta2 * x2 - 136./3 *
        H010 - 608./3 * H010 * x - 1184./9 * H010 * x2 - 16 *
        H010 * zeta2 - 16 * H010 * zeta2 * x + 64 * H0100 + 96 * H0100
        * x - 64./3 * H0100 * x2 + 48 * H01000 + 48 * H01000
        * x + 8./3 * H011 - 116./3 * H011 * x - 1040./9 * H011
        * x2 + 8 * H011 * zeta2 + 8 * H011 * zeta2 * x + 48 * H0110
        ...
        * x + 32 * H01001 + 32 * H01001 * x + 62./3 * H001 +
        ...
        zeta2 + 32 * H001 * zeta2 * x - 24 * H0010 + 88 * H0010 * x
        ...
        * x - 16 * H0001 + 64./3 * H0001 * x2 - 16 * H00010 -
        ...
        5 * x - 3088./15 * x2 + 64./3 * zeta3/x + 80 * zeta3 + 512
        * zeta3 * x - 96 * zeta3 * x2 + 1100./3 * zeta2 + 2204./9 * zeta2
        * x - 2672./9 * zeta2 * x2 - 64./5 * zeta2 * x3 - 16 * zeta2 *
        zeta2 - 48 * zeta2 * zeta2 * x + 128 * H00m10 - 64 * H0m1 * zeta2
        + 64 * H0m1 * zeta2 * x - 128 * H0m1m10 + 128 * H0m1m10
        * x + 160 * H0m10 + 160./3 * H0m10 * x - 64./3 * H0m10
        * x2 + 64 * H0m100 - 64 * H0m100 * x - 32./3 * Hm1 *
        zeta2/x - 160 * Hm1 * zeta2 - 160 * Hm1 * zeta2 * x - 32./3 *
        Hm1 * zeta2 * x2 - 192 * Hm1m10 + 64./3 * Hm1m10/x - 192
        ...
        * x3 + 128 * Hm100 + 128 * Hm100 * x + 64 * Hm101 +
        ...
        + 4976./45 * H0 * x2 + 144 * H0 * zeta3 + 16 * H0 * zeta3 *
        x + 80 * H0 * zeta2 + 1264./3 * H0 * zeta2 * x - 512./3 * H0
        * zeta2 * x2 - 212 * H00 - 1532./9 * H00 * x + 2608./9 *
        H00 * x2 + 64./5 * H00 * x3 + 176 * H00 * zeta2 + 176 *
        H00 * zeta2 * x + 16 * H000 - 544./3 * H000 * x + 320./3
        * H000 * x2 - 80 * H0000 - 80 * H0000 * x - 3196./9 *
        H1 - 232./9 * H1/x + 2548./9 * H1 * x + 880./9 * H1 *
        x2 + 96 * H1 * zeta2/x - 16 * H1 * zeta2 + 16 * H1 * zeta2 * x
        - 96 * H1 * zeta2 * x2 - 920./3 * H10 - 352./9 * H10/x +
        ...
        * x + 1136./9 * H11 * x2 - 64 * H110 - 256./3 * H110/
        ...
        + 96 * H01 * zeta2 + 96 * H01 * zeta2 * x - 144 * H010 - 96
        ...
        * H001 * x + 512./3 * H001 * x2 - 160 * H0010 - 160 *
        ...
        + CF*CF*Lmmu2 * (44 - 44*x - 24*zeta3 - 24*zeta3*x - 8*zeta2
        - 32 * zeta2 * x + 64./3 * zeta2 * x2 + 82./3 * H0 - 106./3
        * H0 * x - 128./3 * H0 * x2 - 24 * H0 * zeta2 - 24 * H0
        * zeta2 * x + 16 * H00 * x - 32./3 * H00 * x2 + 8 * H000
        ...
        /135 * x - 13024./45 * x2 - 128./3 * zeta3/x + 136 * zeta3
        + 584 * zeta3 * x + 1928./3 * zeta2 + 872./9 * zeta2 * x - 1760.
        /9 * zeta2 * x2 - 64./5 * zeta2 * x3 - 368./5 * zeta2 * zeta2 -
        528./5 * zeta2 * zeta2 * x + 128 * H00m10 - 64 * H0m1 * zeta2
        + 64 * H0m1 * zeta2 * x - 128 * H0m1m10 + 128 * H0m1m10
        * x + 160 * H0m10 + 160./3 * H0m10 * x - 64./3 * H0m10
        * x2 + 64 * H0m100 - 64 * H0m100 * x - 32./3 * Hm1 *
        zeta2/x - 160 * Hm1 * zeta2 - 160 * Hm1 * zeta2 * x - 32./3 *
        ...
        * x3 + 128 * Hm100 + 128 * Hm100 * x + 64 * Hm101 + 64.
        ...
        /135 * H0 * x2 + 32 * H0 * zeta3 - 96 * H0 * zeta3 * x + 160
        * H0 * zeta2 + 976./3 * H0 * zeta2 * x - 896./3 * H0 * zeta2 *
        x2 - 342 * H00 + 610./9 * H00 * x + 1472./9 * H00 * x2
        + 64./5 * H00 * x3 + 288 * H00 * zeta2 + 288 * H00 * zeta2
        * x + 80 * H000 - 352./3 * H000 * x + 832./3 * H000 *
        x2 - 168 * H0000 - 168 * H0000 * x - 660 * H1 - 1168.
        /27 * H1/x + 2548./3 * H1 * x - 3944./27 * H1 * x2 +
        96 * H1 * zeta2/x - 16 * H1 * zeta2 + 16 * H1 * zeta2 * x - 96
        * H1 * zeta2 * x2 - 1324./3 * H10 + 128./3 * H10/x + 1324.
        ...
        /9 * H01 * x2 + 96 * H01 * zeta2 + 96 * H01 * zeta2 * x - 112
        ...
        * H001 - 272 * H001 * x + 896./3 * H001 * x2 - 240 *
        ...
        x + 80./3 * x2 - 32 * zeta3 - 32 * zeta3 * x - 112 * zeta2 - 112
        * zeta2 * x + 320./3 * zeta2 * x2 + 140 * H0 - 236 * H0 * x
        - 928./9 * H0 * x2 - 128 * H0 * zeta2 - 128 * H0 * zeta2 *
        ...
        * zeta2 + 16 * zeta2 * x + 8 * H0 * x + 32./3 * H0 * x2 - 8
        * H00 - 8 * H00 * x - 8 * H1 - 32./3 * H1/x + 8 * H1
        * x + 32./3 * H1 * x2 - 16 * H01 - 16 * H01 * x)

        + CF * CF * LQm2 * (506./9 + 8/x - 818./9 * x + 80./
        3 * x2 - 32 * zeta3 - 32 * zeta3 * x - 48 * zeta2 - 16 * zeta2 *
        x + 224./3 * zeta2 * x2 + 88 * H0 - 140 * H0 * x - 16./9
        * H0 * x2 - 80 * H0 * zeta2 - 80 * H0 * zeta2 * x - 16 * H00
        ...
        * zeta2 + 32 * zeta2 * x + 16 * H0 * x + 64./3 * H0 * x2 -
        16 * H00 - 16 * H00 * x - 16 * H1 - 64./3 * H1/x + 16
        * H1 * x + 64./3 * H1 * x2 - 32 * H01 - 32 * H01 * x)

        + CF * CF * LQm3 * (- 92./9 + 92./9 * x + 32./3 * zeta2
        ...
        x + 50344./27 * x2 - 120 * zeta5 + 280 * zeta5 * x + 304./9
        * zeta3/x + 916./3 * zeta3 + 1544./3 * zeta3 * x + 1024./3 * zeta3
        * x2 - 2060./27 * zeta2/x + 1640./9 * zeta2 - 764./3 * zeta2 *
        x + 7364./27 * zeta2 * x2 + 148./3 * zeta2 * zeta3 + 172./3 *
        zeta2 * zeta3 * x + 608./15 * zeta2 * zeta2/x - 548./15 * zeta2 * zeta2
        + 272./3 * zeta2 * zeta2 * x + 16./3 * zeta2 * zeta2 * x2 + 48 *
        H0m1 * zeta3 - 48 * H0m1 * zeta3 * x - 32 * H0m1m1 * zeta2 + 32
        * H0m1m1 * zeta2 * x - 64 * H0m1m1m10 + 64 * H0m1m1m10 *
        x + 32 * H0m1m100 - 32 * H0m1m100 * x + 48 * H0m10 *
        x - 24 * H0m10 * zeta2 + 24 * H0m10 * zeta2 * x + 16 * H0m1000
        - 16 * H0m1000 * x + 32 * H0m1010 - 32 * H0m1010 * x
        - 32 * Hm1 * zeta3/x + 24 * Hm1 * zeta3 + 24 * Hm1 * zeta3 * x
        - 32 * Hm1 * zeta3 * x2 - 160./9 * Hm1 * zeta2/x + 32./3 *
        Hm1 * zeta2 - 16./3 * Hm1 * zeta2 * x - 304./9 * Hm1 * zeta2 *
        x2 + 64./3 * Hm1m1 * zeta2/x - 16 * Hm1m1 * zeta2 - 16 * Hm1m1
        * zeta2 * x + 64./3 * Hm1m1 * zeta2 * x2 - 32 * Hm1m1m10 +
        ...
        * Hm10 + 752./27 * Hm10/x + 320./9 * Hm10 * x + 2912.
        /27 * Hm10 * x2 + 16 * Hm10 * zeta2/x - 12 * Hm10 * zeta2 -
        ...
        * H0 * x2 - 32./9 * H0 * zeta3/x - 1720./9 * H0 * zeta3 + 104.
        /9 * H0 * zeta3 * x - 160./9 * H0 * zeta2/x - 590./9 * H0 *
        zeta2 - 242./9 * H0 * zeta2 * x - 316./3 * H0 * zeta2 * x2 - 8
        * H0 * zeta2 * zeta2 + 304./5 * H0 * zeta2 * zeta2 * x + 380./3 *
        H00 - 908./9 * H00 * x + 8528./27 * H00 * x2 + 208./3
        * H00 * zeta3 - 224./3 * H00 * zeta3 * x + 136./3 * H00 * zeta2
        - 80./3 * H00 * zeta2 * x - 48 * H000 - 188./3 * H000 *
        x - 48 * H000 * x2 - 24 * H000 * zeta2 + 24 * H000 * zeta2
        * x + 136./3 * H0000 - 32./3 * H0000 * x - 16 * H00000
        + 16 * H00000 * x - 656./27 * H1 - 3542./81 * H1/x +
        170./27 * H1 * x + 5000./81 * H1 * x2 + 160./9 * H1 *
        zeta3/x + 40./3 * H1 * zeta3 - 40./3 * H1 * zeta3 * x - 160./9
        * H1 * zeta3 * x2 - 92./9 * H1 * zeta2/x - 26 * H1 * zeta2 + 2
        * H1 * zeta2 * x + 308./9 * H1 * zeta2 * x2 - 2128./9 * H10
        + 5392./27 * H10/x + 4432./9 * H10 * x - 12304./27 *
        H10 * x2 + 16./3 * H10 * zeta2/x + 4 * H10 * zeta2 - 4 * H10
        * zeta2 * x - 16./3 * H10 * zeta2 * x2 + 352./3 * H100 - 904.
        ...
        * x - 64./3 * H1101 * x2 + 32./3 * H101 + 160./9 * H101
        ...
        /27 * H01 * x2 + 80./3 * H01 * zeta3 + 80./3 * H01 * zeta3
        * x + 16./3 * H01 * zeta2/x - 44./3 * H01 * zeta2 - 104./3
        * H01 * zeta2 * x - 16./3 * H01 * zeta2 * x2 + 400./3 * H010
        + 320./9 * H010/x + 640./3 * H010 * x + 1408./9 * H010
        * x2 + 8 * H010 * zeta2 + 8 * H010 * zeta2 * x - 152./3 * H0100
        - 64./3 * H0100/x - 152./3 * H0100 * x - 56./3 * H011
        - 124./3 * H011 * x - 80./9 * H011 * x2 - 8 * H011 *
        zeta2 - 8 * H011 * zeta2 * x - 16 * H01100 - 16 * H01100 *
        x + 8 * H0111 - 8 * H0111 * x + 32 * H01110 + 32 * H01110
        * x - 16 * H01111 - 16 * H01111 * x + 32 * H01101 + 32
        * H01101 * x + 32 * H01010 + 32 * H01010 * x + 16 * H01011
        + 16 * H01011 * x + 8 * H001 * zeta2 + 8 * H001 * zeta2 * x
        - 272./3 * H0010 + 16./3 * H0010 * x + 32 * H00100 -
        64 * H00100 * x - 8 * H0011 * x + 32 * H00010 - 32 *
        H00010 * x)

        + CA * CF * Lmmu * (- 6788./27 - 2848./27/x + 42464.
        /27 * x - 32828./27 * x2 - 376./3 * zeta3 - 904./3 * zeta3
        * x - 64 * zeta3 * x2 + 128./3 * zeta2/x - 1712./9 * zeta2 + 232.
        /9 * zeta2 * x - 1304./3 * zeta2 * x2 - 208./5 * zeta2 * zeta2 -
        ...
        * zeta2/x - 24 * Hm1 * zeta2 - 24 * Hm1 * zeta2 * x + 64 * Hm1
        * zeta2 * x2 + 16 * Hm1m10 + 128./3 * Hm1m10/x + 16 * Hm1m10
        ...
        * H0 * x + 26104./27 * H0 * x2 + 96 * H0 * zeta3 - 32 *
        H0 * zeta3 * x + 64./3 * H0 * zeta2/x + 320./3 * H0 * zeta2 +
        320./3 * H0 * zeta2 * x - 128./3 * H0 * zeta2 * x2 + 3680./
        9 * H00 - 2776./9 * H00 * x + 3608./9 * H00 * x2 - 32
        * H00 * zeta2 + 160 * H00 * zeta2 * x - 448./3 * H000 - 1264.
        /3 * H000 * x + 96 * H0000 - 128 * H0000 * x - 2704./
        9 * H1 + 6608./27 * H1/x + 2632./9 * H1 * x - 6392./27
        * H1 * x2 + 128./3 * H1 * zeta2/x + 56 * H1 * zeta2 - 56 *
        H1 * zeta2 * x - 128./3 * H1 * zeta2 * x2 + 104 * H10 - 1616.
        ...
        * H01 * x2 + 80 * H01 * zeta2 + 80 * H01 * zeta2 * x - 248.
        ...
        * x2 - 48 * zeta3 * x - 32./3 * zeta2/x - 112./3 * zeta2 - 184.
        /3 * zeta2 * x + 32./3 * zeta2 * x2 - 84 * H0 - 16./3 * H0/x
        + 140 * H0 * x - 176./3 * H0 * x2 - 48 * H0 * zeta2 * x
        ...
        * x + 13340./27 * x2 + 128 * zeta3/x - 112./3 * zeta3 - 280.
        /3 * zeta3 * x - 608./3 * zeta3 * x2 + 352./3 * zeta2/x - 3604.
        /9 * zeta2 + 1484./9 * zeta2 * x - 376 * zeta2 * x2 + 28 * zeta2
        * zeta2 + 164./5 * zeta2 * zeta2 * x + 112 * H00m10 - 48 * H00m10
        * x - 48 * H0m1 * zeta2 + 48 * H0m1 * zeta2 * x + 32 * H0m1m10
        - 32 * H0m1m10 * x - 104 * H0m10 + 64./3 * H0m10/x +
        8 * H0m10 * x - 320./3 * H0m10 * x2 + 112 * H0m100 -
        112 * H0m100 * x + 64 * H0m101 - 64 * H0m101 * x + 64
        * Hm1 * zeta2/x + 24 * Hm1 * zeta2 + 24 * Hm1 * zeta2 * x + 64
        * Hm1 * zeta2 * x2 + 48 * Hm1m10 + 48 * Hm1m10 * x + 832.
        ...
        * x - 96 * Hm100 * x2 - 64 * Hm101/x - 64 * Hm101 * x2
        ...
        x - 3728./27 * H0 * x2 + 240 * H0 * zeta3 + 224 * H0 * zeta3
        * x + 64./3 * H0 * zeta2/x + 28 * H0 * zeta2 + 124 * H0 * zeta2
        * x - 160./3 * H0 * zeta2 * x2 + 5188./9 * H00 - 4160./9
        * H00 * x + 6032./9 * H00 * x2 - 24 * H00 * zeta2 + 152
        * H00 * zeta2 *x - 272 * H000 - 328 * H000 * x + 176 * H0000
        - 192 * H0000 * x - 404./3 * H1 + 8840./27 * H1/x - 148.
        /3 * H1 * x - 3872./27 * H1 * x2 + 160./3 * H1 * zeta2/x
        + 64 * H1 * zeta2 - 64 * H1 * zeta2 * x - 160./3 * H1 * zeta2
        ...
        * H101 * x + 160./3 * H101 * x2 + 3604./9 * H01 + 832.
        ...
        H01 * zeta2 + 96 * H01 * zeta2 * x - 16 * H010 - 128./3 * H010
        ...
        * x + 1448./27 * x2 - 64 * zeta3 + 32 * zeta3 * x - 16 * zeta2
        - 32 * zeta2 * x + 128./3 * zeta2 * x2 - 64 * H0m10 + 64 *
        ...
        * x2 + 16 * H01 + 128./3 * H01/x - 128./3 * H01 * x2
        ...
        176./3 * x2 + 16 * zeta2 + 16 * zeta2 * x - 88./3 * H0 - 32.
        /3 * H0/x - 64./3 * H0 * x + 16 * H00 - 32 * H00 * x
        - 8 * H1 - 32./3 * H1/x + 8 * H1 * x + 32./3 * H1 * x2
        - 16 * H01 - 16 * H01 * x)

        + CA * CF * LQm2 * (584./3 - 3604./27/x - 88 * x + 724.
        /27 * x2 - 32 * zeta3 + 16 * zeta3 * x - 8 * zeta2 - 16 * zeta2 *
        x + 64./3 * zeta2 * x2 - 32 * H0m10 + 32 * H0m10 * x - 16
        ...
        * H10 * x - 64./3 * H10 * x2 + 16 * H11 + 64./3 * H11/x
        ...
        x2 + 16./3 * zeta2 + 16./3 * zeta2 * x - 88./9 * H0 - 32./9
