...
double D2_g3_highscale(double x, double mQ, double mMu, int nf, int v) {
    ...
    return (
        ...
        + CF * (
            ...
            - 8 * zeta5 + 16 * zeta5 * x + 32./27 * zeta3 / x - 700./9 * zeta3 + 1504./
            9 * zeta3 * x - 680./27 * zeta3 * x2 - 128./27 * zeta2/x - 4081./18 * zeta2
            + 1286./9 * zeta2 * x + 992./27 * zeta2 * x2 - 364./15 * zeta2 * zeta2 + 776.
            /15 * zeta2 * zeta2 * x - 872./15 * zeta2 * zeta2 * x2 + 7 * H0 - 526 * H0 * x +
            538./3 * H0 * x2 - 296./9 * H0 * zeta3 + 592./9 * H0 * zeta3 * x - 32*
            H0 * zeta3 * x2 - 1063./9 * H0 * zeta2 + 1124./9 * H0 * zeta2 * x + 8./3 * H0
            * zeta2 * x2 - 16./5 * H0 * zeta2 * zeta2 + 32./5 * H0*zeta2*zeta2*x + 88./3*
            H00 - 100*H00*x - 272./3*H00*x2 - 32./3*H00*zeta3 + 64.
            /3*H00*zeta3*x - 118./3*H00*zeta2 + 224./3*H00*zeta2*x + 64.
            /3*H00*zeta2*x2 + 32./3*H000 - 168*H000*x + 80./3*H000
            *x2 - 20*H000*zeta2 + 40*H000*zeta2*x + 8./3*H0000 - 160.
            /3*H0000*x + 32./3*H0000*x2 + 793./3*H1 + 16./3*H1/
            x - 1558./3*H1*x + 270*H1*x2 - 160./9*H1*zeta3 + 320./
            9*H1*zeta3*x - 320./9*H1*zeta3*x2 - 20./9*H1*zeta2 - 80./9*H1
            *zeta2*x + 80./9*H1*zeta2*x2 - 80./3*H10 + 72*H10*x - 128.
            /3*H10*x2 + 16./3*H10*zeta2 - 32./3*H10*zeta2*x + 32./3*
            H10*zeta2*x2 + 8./3*H100 - 32*H100*x + 80./3*H100*x2 +
            16./3*H1000 - 32./3*H1000*x + 32./3*H1000*x2 + 32./
            3*H11 - 136./3*H11*x + 32*H11*x2 + 52./3*H11*zeta2 -
            104./3*H11*zeta2*x + 104./3*H11*zeta2*x2 - 16./3*H111 -
            ...
            *x + 32./3*H1111*x2 - 32./3*H1101 + 64./3*H1101*x -
            ...
            52./3*H01*zeta2 - 104./3*H01*zeta2*x + 104./3*H01*zeta2*x2 -
        ...
        + CF*Lmmu * (
            ...
            176./15*x2 + 112./3*zeta3 + 32./3*zeta3*x + 320./3*zeta3*x2 +
            16*zeta2 - 704./9*zeta2*x + 112*zeta2*x2 + 128./5*zeta2*x3 + 128.
            /3*H0m10 + 128./3*H0m10*x2 - 64./3*Hm1*zeta2 - 128./3*
            Hm1*zeta2*x - 64./3*Hm1*zeta2*x2 - 128./3*Hm1m10 - 256./3*
            ...
            45*H0/x + 392./15*H0*x - 488./5*H0*x2 + 64./3*H0*zeta2
            - 128./3*H0*zeta2*x + 64*H0*zeta2*x2 - 16./3*H00 + 32./9*
            H00*x - 208./3*H00*x2 - 128./5*H00*x3 - 32./3*H000 +
            64./3*H000*x - 128./3*H000*x2 - 68./3*H1 + 96*H1*x -
            72*H1*x2 + 32./3*H1*zeta2 - 64./3*H1*zeta2*x + 128./3*H1*zeta2
        ...
        + CF*LQm * (
            ...
            /135*x - 269954./405*x2 + 352./3*zeta3 - 224*zeta3*x + 128.
            /3*zeta3*x2 - 64./9*zeta2/x + 812./3*zeta2 - 1120./9*zeta2*x +
            1280./9*zeta2*x2 + 64./5*zeta2*x3 + 8./5*zeta2*zeta2 - 16./5*zeta2*
            zeta2*x + 160./3*H0m10 - 64*H0m10*x + 128./3*H0m10*x2 -
            ...
            H0/x + 22528./45*H0*x - 5776./45*H0*x2 + 32*H0*zeta3 -
            64*H0*zeta3*x + 88*H0*zeta2 - 224*H0*zeta2*x - 32./3*H0*zeta2*x2
            - 4760./9*H00 + 4256./9*H00*x - 896./9*H00*x2 - 64./
            5*H00*x3 + 48*H00*zeta2 - 96*H00*zeta2*x - 160*H000 + 480*
            H000*x + 64*H000*x2 - 96*H0000 + 192*H0000*x - 1166.
            /3*H1 - 512./27*H1/x + 5632./9*H1*x - 6160./27*H1*x2
            + 16*H1*zeta2 - 32*H1*zeta2*x + 128./3*H1*zeta2*x2 - 1120./9*
        ...
        + CF*LQm*Lmmu * (
            ...
            32*zeta2*x - 128./3*zeta2*x2 + 16./3*H0 - 32*H0*x + 160./3
        ...
        + CF*LQm2 * (
            ...
            /27*x2 - 8*zeta3 + 16*zeta3*x - 52./3*zeta2 + 32./3*zeta2*x - 16.
            /3*zeta2*x2 + 1142./9*H0 - 472./9*H0*x + 488./9*H0*x2 -
            8*H0*zeta2 + 16*H0*zeta2*x + 124./3*H00 - 224./3*H00*x -
