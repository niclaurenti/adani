...
//  condition Qq at O(alpha_s^3).
//  Both the exact resul and the approximate one are implemented.
//  The latter is used just as benchmark for the plots of the paper.
//
...
double a_Qq_PS_30(double x, double* Hr1, double* Hr2, double* Hr3, double* Hr4, double* Hr5, int v) {
    ...
    if(v==1) {
       ...
       return (
        ...
        double aQqPS30 = (
            // This contribution has been already introduced in D2_ps3_highscale
            /*CF * nf * TR * TR * (
                16. / 81 * (x - 1.) / x * (4. * x2 + 7 * x + 4) * H1 * H1 * H1
                + 64./729 * (x - 1.) / x * (5165 * x2 - 2632 * x + 1736)
                - 64./243 * (1350 * x2 - 569 * x - 218) * H0
                + 64./81 * (111 * x2 + 64 * x + 100) * H0 * H0
                - 128./81 * (6 * x2 + 4 * x - 5) * H0 * H0 * H0
                + 64./27 * (x + 1.) * H0 * H0 * H0 * H0
                + (
                    64./9 * (x - 1.) / x * (4. * x2 + 7. * x + 4.) * H0 * H0
            ...
            + CF * TR * TR * (
                - 32./81 * (x - 1.) / x * (4. * x2 + 7. * x + 4.) * H1 * H1 * H1
                - 128./1215 * (
                    18. * x4 - 171. * x3 + 3006. * x2 + 3502. * x + 775.
                ) * H0
                - 128./3645 * (x - 1.) / x * (
                    108. * x4 - 918. * x3 - 13889. * x2 + 145. * x - 3035.
                )
                + 64./405 * (
                    6 * x5 - 60 * x4 + 30 * x3 + 630 * x2 - 985 * x + 320
                ) * H0 * H0
                - 128./81 * (6 * x2 + 4 * x - 5) * H0 * H0 * H0
                + 64./27 * (x + 1) * H0 * H0 * H0 * H0
                + (
                    ...
                    + 64./135 * (x-1)/x * (4 * x5 - 36 * x4
                    - 16 * x3 - 156 * x2 - 431 * x - 100) * H0
                ) * H1
                + (
                    - 32./9 * (x-1)/x * (4 * x2 + 7 * x + 4) * H0
                    - 32./405 * (x - 1) / x * (
            ...
            + CF * CF * TR * (
                ...
                + 4./81 * (4376 * x3 + 5311 * x2 - 9879 * x + 840) * H0 * H0/(1 - x)
                + 4./81 * (11500 * x2 - 1187 * x + 3989) * H0
                - 2./27 * (704 * x2 - 313 * x + 151) * H0 * H0 * H0
                + 4./27 * (76 * x2 + 15 * x + 33) * H0 * H0 * H0 * H0
                - 6./5 * (x + 1) * H0 * H0 * H0 * H0 * H0
                +(
                    -80. /27 * (x - 1)/x * (4 * x2 + 7 * x + 4) * H0 * H0 * H0
                    + 16./81 * (x - 1)/x * (67 * x2 - 1320 * x - 1490)
                    + 4./27 * (x - 1)/x * (904 * x2 + 2683 * x - 392) * H0 * H0
                    - 16. /81 * (x - 1)/x * (1312 * x2 + 4357 * x - 722) * H0
                ) * H1
                + (
                ...
                + (
                    ...
                    - 16./9 * 1./x * (4 * x3 + 225 * x2 + 54 * x + 20) * H0 * H0
                    - 16./27 * 1./x * (882 * x3 + 1527 * x2 - 2364 * x + 196) * H0
                    + 16./81 * 1./x * (3293 * x3 + 8316 * x2 - 5229 * x + 722)
                    + 160./9 * (x + 1) * H0 * H0 * H0
                    + (
                        -448. /9 * (x - 1)/x * (4 * x2 + 7 * x + 4) * H0
                        + 64./9 * 1./x * (2 * x3 - 102 * x2 + 102 * x - 11)
                    ) * H1
                ) * H01
                + (
                ...
                + (
                    ...
                    - 32./9 * 1./x * (28 * x3 - 537 * x2 - 123 * x - 20) * H0
                    + 8./27 * 1./x * (1652 * x3 + 3273 * x2 - 7665 * x + 392)
                    - 48 * (x + 1) * H0 * H0 - 1792./3 * (x + 1) * H01
                ) * H001
                + (
                    608./9 * (x - 1) /x * (4 * x2 + 7 * x + 4) * H1
                    + 32./3 * 1./x * (36 * x3 + 23 * x2 - 32 * x - 40) * H0
                    + 32./27 * 1./x * (209 * x3 + 1743 * x2 - 1572 * x + 152)
                    + 64./3 * (x + 1) * H0 * H0 + 128 * (x + 1) * H01
                ) * H011
                + (
                ...
                + (
                    -16./9 * 1./x * (300 * x3 + 243 * x2 - 219 * x - 304)
                    + 64./3 * (x + 1) * H0
                ) * H0111
                ...
                + (
                    124./9 * (x - 1)/x * (4 * x2 + 7 * x + 4) * H1 * H1
                    - 4./81 * 1./x * (8896 * x3 + 21003 * x2 + 129 * x - 1620)
                    + 2./9 * (1536 * x2 + 1879 * x + 1943) * H0
                    - 8./9 * (68 * x2 + 99 * x - 57) * H0 * H0
                    + 188./9 * (x + 1) * H0 * H0 * H0
                    + (
                        112./9 * (x - 1)/x * (4 * x2 + 7 * x + 4) * H0
                        + 4./27 * 1./x * (752 * x3 + 4197 * x2 - 5169 * x + 652)
                    ) * H1
                    + (
                        8./9 * 1./x * (196 * x3 - 327 * x2 - 213 * x + 56)
                        - 224./3 * (x + 1) * H0
                    ) * H01
                ...
                + (
                    ...
                    - 4./27 * 1./x * (2824 * x3 - 4125 * x2 - 17331 * x + 1938)
                    - 16. /3 * (76 * x2 - 275 * x - 112) * H0
                    + 920./3 * (x + 1) * H0 * H0 + 1184./3 * (x + 1) * H01
                ) * zeta3
                ...
                + 256 * (x + 1) * B_4 * ln2 + 944./ 3 * (x + 1) * zeta2 * zeta3
            ...
            + CA * CF * TR * (
                ...
                - 8./729 * (x - 1)/x * (1024228 * x2 - 83309 * x + 274870)
                + (
                    - 112./27 * (x + 1)/x * (4 * x2 - 7 * x + 4) * Hm1 * Hm1 * Hm1
                    + 32./27 * (x + 1)/x * (188 * x2 - 83 * x + 80) * Hm1*Hm1
                    - 8./27 * (x + 1)/x * (4200 * x2 - 1577 * x + 1236) * Hm1
                    + 4./243 * 1./x * (503464 * x3 + 110993 * x2 + 171290 * x + 20992)
                ) * H0
                + (
                    - 2./3 * (x + 1)/x * (40 * x2 - 37 * x + 40) * Hm1 * Hm1
                    + 4./27 * 1./x * (202 * x3 - 18 * x2 + 9 * x + 256) * Hm1
                ) * H0 * H0
                + 4./81 * 1./(x + 1) * (
                ...
                + 2./27 * (95 * x - 172) * H0 * H0 * H0 * H0
                - 4./15 * (4 * x - 5) * H0 * H0 * H0 * H0 * H0
                + (
                    4./27 * (x - 1)/x * (152 * x2 + 203 * x + 152) * H0 * H0 * H0
                    - 4./243 * (x - 1)/x * (6776 * x2 + 15425 * x - 11926)
                    + 8./81 * (x - 1)/x * (21512 * x2 - 1057 * x + 7436) * H0
                    - 4./9 * 1./x * (936 * x3 - 640 * x2 + 379 * x - 684) * H0 * H0
                ) * H1
                + (
                    -2./9 * (x - 1)/x * (136 * x2 + 283 * x + 136) * H0 * H0
                    + 8./27 * (x - 1)/x * (481 * x2 + 340 * x + 184) * H0
                ...
                + (
                    ...
                    + 112./9 * (x + 1)/x * (4 * x2 - 7 * x + 4) * Hm1 * Hm1
                    - 64./27 * (x + 1)/x * (188 * x2 - 83 * x + 80) * Hm1
                    + 8./27 * (x + 1)/x * (4200 * x2 - 1577 * x + 1236)
                    - 4./9 * 1./x * (112 * x3 - 27 * x2 - 57 * x + 168) * H0 * H0
                    + (
                        - 8./9 * (x + 1)/x * (40 * x2 - 151 * x + 40) * Hm1
                        + 8./27 * 1./x * (1102 * x3 - 2154 * x2 + 765 * x - 256)
                    ) * H0
                    + 280./9 * (x - 1) * H0 * H0 * H0
                ) * H0m1
                + (
                    ...
                    + (
                        - 8./9 * (x + 1)/x * (32 * x2 +61 * x + 32) * Hm1 * Hm1
                        - 16./27 * 1./x * (82 * x3 - 78 * x2 - 267 * x - 80) * Hm1
                        - 4./9 * 1./x * (144 * x3 - 555 * x2 - 471 * x - 344) * H0 * H0
                        - 8./81 * 1./(x + 1)/x * (
                            20970 * x4 + 2819 * x3 - 10430 * x2 + 857 * x - 6540
                        )
                        + (
                            8./9 * 1./x * (154 * x3 - 1068 * x2 - 217 * x - 844)
                            + 64 * (x + 1)/x * (2 * x2 - 3 * x + 2) * Hm1
                        ) * H0
                        - 248./9 * (x + 1) * H0 * H0 * H0
                        + (
                            8./9 * (x - 1)/x * (184 * x2 + 349 * x + 184) * H0
                            - 16./27 * 1./x * (167 * x3 - 711 * x2 + 657 * x - 140)
                        ) * H1
                        + (
                ...
                + (
                    ...
                    + 8./9 * 1./x * (56 * x3 + 51 * x2 - 285 * x + 200) * H0
                    - 152./3 * (x - 1) * H0 * H0 + 448./3 * (x - 1) * H0m1
                ) * H0m1m1
                + (
                    16./9 * (x + 1)/x * (32 * x2 + 61 * x + 32) * Hm1
                    - 32./9 * 1./x * (32 * x3 - 3 * x2 - 33 * x + 40) * H0
                    + 16./27 * 1./x * (82 * x3 - 78 * x2 - 267 * x - 80)
                ) * H0m11
                + (
                    64./9 * (x - 1) /x * (4 * x2 - 11 * x + 4) * H1
                    + 8./9 * (x + 1)/x * (200 * x2 - 413 * x + 200) * Hm1
                    - 8./3 * 1./x * (8 * x3 - 9 * x2 + 27 * x - 56) * H0
                    - 8./27 * 1./x * (2406 * x3 - 4326 * x2 + 1539 * x - 256)
                    - 32./3 * (15 * x - 17) * H0 * H0
                    + 304 * (x - 1) * H0m1 + 128./3 * (x + 1) * H01
                ) * H00m1
                + (
                    - 8./3 * (x + 1)/x * (88 * x2 - 169 * x + 88) * Hm1
                    - 8./9 * (x - 1)/x * (296 * x2 + 491 * x + 296) * H1
                    + 8./9 * 1./x * (136 * x3 - 1605 * x2 - 591 * x - 536) * H0
                    + 8./27 * 1./x * (1936 * x3 + 3913 * x2 + 3019 * x + 3012)
                    + 16./3 * (69 * x + 25) * H0 * H0
                ...
                + (
                    ...
                    - 16./9 * 1./x * (148 * x3 + 189 * x2 - 45 * x - 140) * H0
                ...
                + (
                    -16./9 * 1./x * (68 * x3 - 1577 * x2 - 260 * x - 364)
                    - 496 * (3 * x + 1) * H0
                ) * H0001
                + (
                    8./3 * (x + 1)/x * (88 * x2 - 169 * x + 88)
                ...
                - 64./9 * (x + 1)/x * (2 * x2 + x + 2) * (H01m11 + H011m1)
                + (
                    16./9 * 1./x * (104 * x3 + 101 * x2 - 64 * x - 104)
                    - 256./3 * (x + 1) * H0
                ) * H0111
                + 160./3 * (x - 1) * H0m1m101 - 896./3 * (x - 1) * H0m10m1m1
                - 1792./3 * (x - 1) * H00m1m1m1 - 624 * (x - 1) * H00m10m1
                + 32./3 * (33 * x - 41) * H00m101 - 1872 * (x - 1) * H000m1m1
                + 16 * (63 * x - 79) * H000m11 - 128 * (3 * x - 1) * H0000m1
                + 16./3 * (411 * x + 197) * H00001 + 16 * (63 * x - 79) * H0001m1
                - 16./3 * (341 * x + 347) * H00011 + 16./3 * (63 * x - 79) * H0010m1
                - 32./3 * (68 * x + 67) * H00101 + 160 * (x + 1) * H00111
                + 352./3 * (x + 1) * H01011 + 32./3 * (x + 1) * H01111
                + (
                    16./9 * (x + 1)/x * (2 * x2 + 55 * x + 2) * Hm1 * Hm1
                    - 20./9 * (x - 1)/x * (4 * x2 + 7 * x + 4) * H1 * H1
                    + 16./27 * 1./x * (458 * x3 + 132 * x2 - 273 * x + 80) * Hm1
                    - 8./81 * 1./(x + 1)/x * (
                        5729 * x4 + 3096 * x3 + 1145 * x2 + 4805 * x + 703
                    )
                    + (
                        -8./9 * (x + 1)/x * (148 * x2 - 97 * x + 148) * Hm1
                        + 4./27 * 1./x * (1318 * x3 - 2183 * x2 - 275 * x + 240)
                    ) * H0
                    + 4./9 * (8 * x2 + 23 * x - 211) * H0 * H0
                    - 16./9 * (5 * x - 4) * H0 * H0 * H0
                    + (
                        - 4./27 * 1./x * (214 * x3 + 3147* x2 - 3579 * x + 326)
                ...
                + (
                    ...
                    - 16./9 * 1./x * (52 * x3 + 819 * x2 - 144 * x + 28) * H0
                    - 4./27 * 1./x * (4612 * x3 + 15262 * x2 + 8524 * x + 2559)
                    + (16 * (x - 4) * (x + 1) * (4 * x - 1) * Hm1) / x
                    + 64./3 * (5 * x - 6) * H0 * H0 + 608./3 * (x - 1) * H0m1
                    - 496./3 * (x + 1) * H01
                ) * zeta3
                - 896 * (x + 1) * zeta3 * ln2_2
                + (
                ...
                + (
                    -2./9 * 1./x * (1752 * x3 + 11325 * x2 + 1401 * x + 1828)
                    - 76./3 * (17 * x - 15) * H0
                ) * zeta4
                - 832 * (x + 1) * zeta4 * ln2
                + (
                    16./3 * 1./x * (8 * x3 - 30 * x2 - 15 * x - 2) - 64 * (x + 1) * H0
                ) * B_4
                - 128 * (x + 1) * B_4 * ln2 + 8./3 * (31 * x - 127) * zeta2 * zeta3
                - 12 * (47 * x - 145) * zeta5
                - 2048 * Li_512 * (x + 1) + 256./15 * (x+1) * ln2_5
            )
        ) ;
        ...
        double tildeaQqPS30 = (
            CF * TR * (CA / 2 - CF) * (
                ...
                + 64./3 * (x - 1)/x * (4 * x2 + 7 * x + 4) * H1 * tildeH0m1m1
                + 16./3 * 1./x * (32 * x3 + 200 * x2 - 104 * x + 1) * tildeH0m1m1
                + 64./3 * (4 * x2 - 21 * x - 9) * H0 * tildeH0m1m1
                - 128 * (x + 1) * H01 * tildeH0m1m1
                + (
                    - 64./3 * (x - 1)/x * (4 * x2 + 7 * x + 4) * H1
                    - 16./3 * 1./x * (32 * x3 + 200 * x2 - 104 * x + 1)
                    - 64./3 * (4 * x2 - 21 * x - 9) * H0 + 64 * (x + 1) * H0 * H0
                    + 128 * (x + 1) * H01
                ) * tildeH0m11
                + (
                    64./3 * (x - 1)/x * (4 * x2 + 7 * x + 4) * H1
                ...
                + (-64 * (4 * x2 - 21 * x - 9) + 384 * (x + 1) * H0) * tildeH0111
                - 384 * (x + 1) * tildeH0m1m1m11 - 256 * (x + 1) * tildeH0m1m11m1
                + 384 * (x + 1) * tildeH0m1m111 - 128 * (x + 1) * tildeH0m11m1m1
                - 384 * (x + 1) * tildeH0m111m1 + 768 * (x + 1) * tildeH0m1111
                - 384 * (x + 1) * tildeH01m1m11 - 256 * (x + 1) * tildeH01m11m1
                + 384 * (x + 1) * tildeH01m111 - 128 * (x + 1) * tildeH011m1m1
                - 384 * (x + 1) * tildeH0111m1 + 768 * (x + 1) * tildeH01111
                + 64 * (x + 1) * (tildeH0m1m1 - tildeH0m11 + tildeH01m1 - tildeH011) * zeta2
                - 128 * (x + 1) * (tildeH0m1 + tildeH01) * zeta2 * ln2
                + (
                    -128./3 * (x - 1)/x * (4 * x2 + 7 * x + 4) * H1 * tildeH0m1
                    - 32. /3 * 1./x * (32 * x3 + 200 * x2 - 104 * x + 1) * tildeH0m1
                    - 128./3 * (4 * x2 - 21 * x - 9) * H0 * tildeH0m1
                    + 128 * (x + 1) * H0 * H0 * tildeH0m1
                    + (
                    ...
                    + (256 * (x + 1) * tildeH0m1 + 256 * (x + 1) * tildeH01) * H01
                    + (
                ...
                + (
                    256 * (12 * x2 + 3 * x - 2) / (3 * x) * (tildeH0m1 + tildeH01)
                    + 512 * (x + 1) * (tildeH0m1m1 + tildeH0m11 + tildeH01m1 + tildeH011)
                ) * ln2_2
            )
        ) ;
