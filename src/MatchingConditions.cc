...
double a_Qq_PS_30(double x, int v) {
    ...
    if (v == 0) {
        ...
        apf_hplog_(
            &wx, &nw, tildeHr1, tildeHr2, tildeHr3, tildeHr4, tildeHr5, &n1,
            &n2
        );
        ...
        double tildeaQqPS30 =
             ...
             * (-64 * (x + 1) * H0 * H0 * tildeH0m1m1
                ...
                - 256 * (x + 1) * tildeH0m1m11m1
                + 384 * (x + 1) * tildeH0m1m111
                - 128 * (x + 1) * tildeH0m11m1m1
                ...
                + (-128. / 3 * (x - 1) / x * (4 * x2 + 7 * x + 4) * H1
                   ...
                   + 640 * (x + 1) * tildeH0m1m11
                   + 128 * (x + 1) * tildeH0m11m1
                   + 1152 * (x + 1) * tildeH0m111
