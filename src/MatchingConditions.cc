    ...
    if(v==0){
        ...
        double aQqPS30 = (
            ...
            + CF * CF * TR * (
                ...
                + 4./81 * (4376 * x3 + 5311 * x2 - 9879 * x + 840) * H0_2/(1 - x)
                ...
                +(
                    ...
                    + 4./27 * (x - 1)/x * (904 * x2 + 2683 * x - 392) * H0_2
                ...
                + (
                    ...
                    - 16./9 * 1./x * (4 * x3 + 225 * x2 + 54 * x + 20) * H0_2
            ...
            + CA * CF * TR * (
                ...
                - 4./15 * (4 * x - 5) * H0_5
                + (
                    4./27 * (x - 1)/x * (152 * x2 + 203 * x + 152) * H0_3
                    - 4./243 * (x - 1)/x * (6776 * x2 + 15425 * x - 11926)
                    + 8./81 * (x - 1)/x * (21512 * x2 - 1057 * x + 7436) * H0
                    - 4./9 * 1./x * (936 * x3 - 640 * x2 + 379 * x - 684) * H0_2
                ) * H1
                + (
                    -2./9 * (x - 1)/x * (136 * x2 + 283 * x + 136) * H0_2
                ...
                + (
                    ...
                    - 4./9 * 1./x * (112 * x3 - 27 * x2 - 57 * x + 168) * H0_2
                    + (
                ...
                + (
                    ...
                    + (
                        ...
                        - 4./9 * 1./x * (144 * x3 - 555 * x2 - 471 * x - 344) * H0_2
                        - 8./81 * 1./(x + 1)/x * (
                ...
                + (
                    ...
                    + 64./3 * (5 * x - 6) * H0_2 + 608./3 * (x - 1) * H0m1
                    - 496./3 * (x + 1) * H01
                ) * zeta3
                - 896 * (x + 1) * zeta3 * ln2_2
                + (
