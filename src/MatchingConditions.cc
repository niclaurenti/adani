...
double a_Qg_30(double x, int v) {
    ...
    if(v==0) {
        ...
        res = 354.1002*L13 + 479.3838*L12 - 7856.784*(2-x) - 6233.530*L2 + 9416.621/x + 1548.891/x*L;
    }
    else if(v==2) {//Updated version w.r.t v==4
        res = 226.3840*L13 - 652.2045*L12 - 2686.387*L1 - 7714.786*(2-x) - 2841.851*L2 + 7721.120/x + 1548.891/x*L ;
    }
    else if(v==3) { // do not use this version
        res = L/x*CA*CA*(41984./243 + 160./9*zeta(2) - 224./9*zeta(3));
    }
    else if(v==4) { //Version of the paper (used only for benchamrk)
        res = -2658.323*L12 - 7449.948*L1 - 7460.002*(2-x) + 3178.819*L2 + 4710.725/x + 1548.891/x*L;
    }
    else {
