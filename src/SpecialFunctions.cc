...
double Hm1m10(double x) {
    ...
    return H0(x) * Hm1m1(x) - H0m1m1(x) - Hm10m1(x);
}
...
double Hm1m11(double x) {
    ...
    return 0.5 * Hm1(x) * Hm11(x) - 0.5 * Hm11m1(x);
}
...
double Hm10m1(double x) {
    ...
    return H0m1(x) * Hm1(x) - 2. * H0m1m1(x);
}
...
double Hm101(double x) {
    ...
    return Hm1(x) * H01(x) - H0m11(x) - H01m1(x);
}
...
double Hm11m1(double x) {
    ...
    return Hm1(x) * H1m1(x) - 2. * H1m1m1(x);
}
...
double Hm110(double x) {
    ...
    return H0(x) * Hm11(x) - H0m11(x) - Hm101(x);
}
...
double H1m10(double x) {
    ...
    return H0(x) * H1m1(x) - H01m1(x) - H10m1(x);
}
...
double H10m1(double x) {
    ...
    return H1(x) * H0m1(x) - H01m1(x) - H0m11(x);
}
...
double H11m1(double x) {
    ...
    return 0.5 * H1(x) * H1m1(x) - 0.5 * H1m11(x);
}
