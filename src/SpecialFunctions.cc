...
double H_m1m11(double x) {
    ...
    return 0.5 * H_m1(x) * H_m11(x) - 0.5 * H_m11m1(x);
}
...
double H_m10m1(double x) {
    ...
    return H_0m1(x) * H_m1(x) - 2. * H_0m1m1(x);
}
...
double H_m101(double x) {
    ...
    return H_m1(x) * H_01(x) - H_0m11(x) - H_01m1(x);
}
...
double H_m11m1(double x) {
    ...
    return H_m1(x) * H_1m1(x) - 2. * H_1m1m1(x);
}
...
double H_m110(double x) {
    ...
    return H_0(x) * H_m11(x) - H_0m11(x) - H_m101(x);
}
...
double H_1m10(double x) {
    ...
    return H_0(x) * H_1m1(x) - H_01m1(x) - H_10m1(x);
}
...
double H_1m11(double x) {
    ...
    return H_1(x) * H_m11(x) - 2. * H_m111(x);
}
...
double H_10m1(double x) {
    ...
    return H_1(x) * H_0m1(x) - H_01m1(x) - H_0m11(x);
}
...
double H_11m1(double x) {
    ...
    return 0.5 * H_1(x) * H_1m1(x) - 0.5 * H_1m11(x);
}
