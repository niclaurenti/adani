...
MasslessCoefficientFunction::MasslessCoefficientFunction(
    const MasslessCoefficientFunction &obj
)
...
double MasslessCoefficientFunction::C2_g3_massless(double x, int nf) const {
    ...
    const double H10m1 = Hr3[HPL_map(1, 0, -1)];
    ...
    const double H0m1m1m10 = Hr5[HPL_map(0, -1, -1, -1, 0)];
    const double Hm10m1m10 = Hr5[HPL_map(-1, 0, -1, -1, 0)];
    const double H00m1m10 = Hr5[HPL_map(0, 0, -1, -1, 0)];
    const double H10m1m10 = Hr5[HPL_map(1, 0, -1, -1, 0)];
    const double Hm1m10m10 = Hr5[HPL_map(-1, -1, 0, -1, 0)];
    const double H0m10m10 = Hr5[HPL_map(0, -1, 0, -1, 0)];
    const double Hm100m10 = Hr5[HPL_map(-1, 0, 0, -1, 0)];
    const double H000m10 = Hr5[HPL_map(0, 0, 0, -1, 0)];
    const double H100m10 = Hr5[HPL_map(1, 0, 0, -1, 0)];
    const double H010m10 = Hr5[HPL_map(0, 1, 0, -1, 0)];
    const double H110m10 = Hr5[HPL_map(1, 1, 0, -1, 0)];
    const double Hm1m1m100 = Hr5[HPL_map(-1, -1, -1, 0, 0)];
    const double H0m1m100 = Hr5[HPL_map(0, -1, -1, 0, 0)];
    const double Hm10m100 = Hr5[HPL_map(-1, 0, -1, 0, 0)];
    const double H00m100 = Hr5[HPL_map(0, 0, -1, 0, 0)];
    const double H10m100 = Hr5[HPL_map(1, 0, -1, 0, 0)];
    const double Hm1m1000 = Hr5[HPL_map(-1, -1, 0, 0, 0)];
    const double H0m1000 = Hr5[HPL_map(0, -1, 0, 0, 0)];
    const double Hm10000 = Hr5[HPL_map(-1, 0, 0, 0, 0)];
    const double H00000 = Hr5[HPL_map(0, 0, 0, 0, 0)];
    const double H10000 = Hr5[HPL_map(1, 0, 0, 0, 0)];
    const double H01000 = Hr5[HPL_map(0, 1, 0, 0, 0)];
    const double H11000 = Hr5[HPL_map(1, 1, 0, 0, 0)];
    const double Hm10100 = Hr5[HPL_map(-1, 0, 1, 0, 0)];
    const double H00100 = Hr5[HPL_map(0, 0, 1, 0, 0)];
    const double H10100 = Hr5[HPL_map(1, 0, 1, 0, 0)];
    const double H01100 = Hr5[HPL_map(0, 1, 1, 0, 0)];
    const double H11100 = Hr5[HPL_map(1, 1, 1, 0, 0)];
    const double Hm1m1010 = Hr5[HPL_map(-1, -1, 0, 1, 0)];
    const double H0m1010 = Hr5[HPL_map(0, -1, 0, 1, 0)];
    const double Hm10010 = Hr5[HPL_map(-1, 0, 0, 1, 0)];
    const double H00010 = Hr5[HPL_map(0, 0, 0, 1, 0)];
    const double H10010 = Hr5[HPL_map(1, 0, 0, 1, 0)];
    const double H01010 = Hr5[HPL_map(0, 1, 0, 1, 0)];
    const double H11010 = Hr5[HPL_map(1, 1, 0, 1, 0)];
    const double Hm10110 = Hr5[HPL_map(-1, 0, 1, 1, 0)];
    const double H00110 = Hr5[HPL_map(0, 0, 1, 1, 0)];
    const double H10110 = Hr5[HPL_map(1, 0, 1, 1, 0)];
    const double H01110 = Hr5[HPL_map(0, 1, 1, 1, 0)];
    const double H11110 = Hr5[HPL_map(1, 1, 1, 1, 0)];
    const double Hm1m1m101 = Hr5[HPL_map(-1, -1, -1, 0, 1)];
    const double H0m1m101 = Hr5[HPL_map(0, -1, -1, 0, 1)];
    const double Hm10m101 = Hr5[HPL_map(-1, 0, -1, 0, 1)];
    const double H00m101 = Hr5[HPL_map(0, 0, -1, 0, 1)];
    const double H10m101 = Hr5[HPL_map(1, 0, -1, 0, 1)];
    const double Hm1m1001 = Hr5[HPL_map(-1, -1, 0, 0, 1)];
    const double H0m1001 = Hr5[HPL_map(0, -1, 0, 0, 1)];
    const double Hm10001 = Hr5[HPL_map(-1, 0, 0, 0, 1)];
    const double H00001 = Hr5[HPL_map(0, 0, 0, 0, 1)];
    const double H10001 = Hr5[HPL_map(1, 0, 0, 0, 1)];
    const double H01001 = Hr5[HPL_map(0, 1, 0, 0, 1)];
    const double H11001 = Hr5[HPL_map(1, 1, 0, 0, 1)];
    const double Hm10101 = Hr5[HPL_map(-1, 0, 1, 0, 1)];
    const double H00101 = Hr5[HPL_map(0, 0, 1, 0, 1)];
    const double H10101 = Hr5[HPL_map(1, 0, 1, 0, 1)];
    const double H01101 = Hr5[HPL_map(0, 1, 1, 0, 1)];
    const double H11101 = Hr5[HPL_map(1, 1, 1, 0, 1)];
    const double Hm1m1011 = Hr5[HPL_map(-1, -1, 0, 1, 1)];
    const double H0m1011 = Hr5[HPL_map(0, -1, 0, 1, 1)];
    const double Hm10011 = Hr5[HPL_map(-1, 0, 0, 1, 1)];
    const double H00011 = Hr5[HPL_map(0, 0, 0, 1, 1)];
    const double H10011 = Hr5[HPL_map(1, 0, 0, 1, 1)];
    const double H01011 = Hr5[HPL_map(0, 1, 0, 1, 1)];
    const double H11011 = Hr5[HPL_map(1, 1, 0, 1, 1)];
    const double Hm10111 = Hr5[HPL_map(-1, 0, 1, 1, 1)];
    const double H00111 = Hr5[HPL_map(0, 0, 1, 1, 1)];
    const double H10111 = Hr5[HPL_map(1, 0, 1, 1, 1)];
    const double H01111 = Hr5[HPL_map(0, 1, 1, 1, 1)];
    const double H11111 = Hr5[HPL_map(1, 1, 1, 1, 1)];
