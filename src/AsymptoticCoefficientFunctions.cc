...
// double AsymptoticCoefficientFunction::C2_g1_asymptotic(double x, double m2Q2) {
...
// double AsymptoticCoefficientFunction::CL_g1_asymptotic(double x) { return CL_g1_highscale(x); }
